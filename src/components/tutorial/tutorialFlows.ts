...
export const createStartScreenTutorialFlow = (
  ...
  steps: [
    ...
    // Step 4: Complete Provider Modal
    {
      ...
      title: t("tutorial.startScreen.completeProvider.title", "Configure Provider"),
      content: t(
    ...
    // Step 6: Choose Theme
    {
      ...
      title: t("tutorial.startScreen.chooseTheme.title", "Start Your Adventure"),
      content: t(
 ...
 */
export const createGamePageTutorialFlow = (
  t: TFunction
): TutorialFlow => ({
  id: "gamePage",
