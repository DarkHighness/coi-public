          ...
          <div className="max-w-5xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {selectedCategory === "all" && !searchQuery && (
              <button
                ...
                className="relative w-full h-full p-4 rounded-xl border border-theme-primary/30 hover:border-theme-primary transition-all text-left group overflow-hidden bg-linear-to-r from-theme-surface-highlight/50 to-theme-bg hover:shadow-[0_0_15px_rgba(var(--theme-primary),0.2)] flex flex-col items-start justify-between min-h-[200px]"
              >
