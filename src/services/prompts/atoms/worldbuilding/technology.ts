 ...
 * 重点不是名词堆砌，而是“能做什么、成本是什么、谁能做、如何反制”。
 */
...
## Maintenance & Failure (makes tech non-magical)
...
<advanced>
## Advanced: Audit Trails (the world remembers)
  ...
  examples: [
    {
      ...
      right:
        `"Cameras are on a closed loop. You can jam them for 90 seconds,
...
or an insider to schedule a 'maintenance window'."`,
    },
    {
      ...
      right:
        `"The drone’s battery lasts 40 minutes. Recharging requires a docking tower.
