 ...
 * 质量前缀标签
 */
export const imageQualityPrefix: Atom<void> = defineAtom({ atomId: "atoms/image/quality#imageQualityPrefix", source: "atoms/image/quality.ts", exportName: "imageQualityPrefix" }, () =>
 ...
 * 技术规格
 */
export const imageTechnicalSpecs: Atom<void> = defineAtom({ atomId: "atoms/image/quality#imageTechnicalSpecs", source: "atoms/image/quality.ts", exportName: "imageTechnicalSpecs" }, () => `<technical_specs>
