 ...
 */
export const renderTimelineVisible: Atom<RenderTimelineInput> = ({ event }) => {
 ...
 */
export const renderTimelineHidden: Atom<RenderTimelineInput> = ({ event }) => {
 ...
 */
export const renderTimelineFull: Atom<RenderTimelineInput> = ({ event }) => {
  const v = event.visible;
  const h = event.hidden;
