...
export const visualContinuityRules: Atom<
  void
> = defineAtom({ atomId: "atoms/veo/visualContinuity#visualContinuityRules", source: "atoms/veo/visualContinuity.ts", exportName: "visualContinuityRules" }, () => `**CRITICAL: VISUAL CONTINUITY & COHERENCE**
