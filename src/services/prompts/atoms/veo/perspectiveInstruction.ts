 ...
 * 第二人称视角指令
 */
export const perspectiveInstruction: Atom<void> = defineAtom({ atomId: "atoms/veo/perspectiveInstruction#perspectiveInstruction", source: "atoms/veo/perspectiveInstruction.ts", exportName: "perspectiveInstruction" }, () =>
