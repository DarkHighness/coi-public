 ...
 * 电影制作人角色定义
 */
export const cinematographerRole: Atom<void> = defineAtom({ atomId: "atoms/veo/cinematographerRole#cinematographerRole", source: "atoms/veo/cinematographerRole.ts", exportName: "cinematographerRole" }, () =>
