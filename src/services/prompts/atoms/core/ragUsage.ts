...
<rag_usage>
  <instruction>
    **WHEN TO USE \`vfs_search\` (semantic)**:
    ...
    2. **Lore & History**: When the narrative touches on older facts you might not have in the current window.
    3. **Specific Details**: When you need exact wording/details and you’re unsure.
