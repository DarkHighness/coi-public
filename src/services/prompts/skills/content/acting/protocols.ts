...
export function getProtocolsContent(ctx: SkillContext): string {
  if (ctx.isLiteMode) {
    return getProtocolsLiteContent(ctx);
  }

  return `
<protocols>
${getMessageProtocolContent(ctx)}
${getErrorRecoveryContent(ctx)}
${getToolProtocolContent(ctx)}
${getEntityProtocolContent(ctx)}
${getTerminologyContent(ctx)}
</protocols>
`;
}
 ...
 * 精简版协议
 */
export function getProtocolsLiteContent(_ctx: SkillContext): string {
  return `
<protocols>
