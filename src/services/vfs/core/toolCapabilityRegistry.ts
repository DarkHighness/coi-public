...
const CAPABILITIES: VfsToolCapability[] = [
  {
    toolName: "vfs_ls",
    summary: "List VFS directory entries.",
    readOnly: true,
    mayWriteClasses: [],
    needsElevationFor: [],
  ...
  {
    toolName: "vfs_stat",
    summary: "Inspect file and directory metadata.",
    readOnly: true,
    mayWriteClasses: [],
    needsElevationFor: [],
    immutableZones: IMMUTABLE_ZONES,
  ...
  {
    toolName: "vfs_glob",
    summary: "Match paths using glob patterns.",
    readOnly: true,
    mayWriteClasses: [],
    needsElevationFor: [],
    immutableZones: IMMUTABLE_ZONES,
  ...
  {
    toolName: "vfs_ls_entries",
    summary: "List compact entity catalogs.",
    readOnly: true,
    mayWriteClasses: [],
    needsElevationFor: [],
    immutableZones: IMMUTABLE_ZONES,
  ...
  {
    toolName: "vfs_read",
    summary: "Read one file (optionally sliced).",
    readOnly: true,
    mayWriteClasses: [],
    needsElevationFor: [],
    immutableZones: IMMUTABLE_ZONES,
  ...
  },
  {
    ...
    summary: "Read multiple files in one call.",
    readOnly: true,
    mayWriteClasses: [],
    needsElevationFor: [],
    immutableZones: IMMUTABLE_ZONES,
  ...
  },
  {
    ...
    summary: "Read JSON pointer extracts from a JSON file.",
    readOnly: true,
    mayWriteClasses: [],
    needsElevationFor: [],
    immutableZones: IMMUTABLE_ZONES,
  ...
  {
    toolName: "vfs_grep",
    summary: "Regex search through text lines.",
    readOnly: true,
    mayWriteClasses: [],
    needsElevationFor: [],
    immutableZones: IMMUTABLE_ZONES,
  ...
  },
  {
    ...
    summary: "Suggest duplicate entity candidates.",
    readOnly: true,
    mayWriteClasses: [],
    needsElevationFor: [],
    immutableZones: IMMUTABLE_ZONES,
  ...
  {
    toolName: "vfs_write",
    summary: "Create or overwrite files atomically.",
    readOnly: false,
  ...
  {
    toolName: "vfs_append",
    summary: "Append text to files atomically.",
    readOnly: false,
    mayWriteClasses: ["default_editable", "elevated_editable"],
    needsElevationFor: ["elevated_editable"],
    immutableZones: IMMUTABLE_ZONES,
  ...
  {
    toolName: "vfs_text_edit",
    summary: "Apply structured text edits atomically.",
    readOnly: false,
    mayWriteClasses: ["default_editable", "elevated_editable"],
    needsElevationFor: ["elevated_editable"],
    immutableZones: IMMUTABLE_ZONES,
  ...
  {
    toolName: "vfs_text_patch",
    summary: "Apply base->next text patches atomically.",
    readOnly: false,
    mayWriteClasses: ["default_editable", "elevated_editable"],
    needsElevationFor: ["elevated_editable"],
    immutableZones: IMMUTABLE_ZONES,
  ...
  {
    toolName: "vfs_edit",
    summary: "Apply JSON Patch operations atomically.",
    readOnly: false,
    mayWriteClasses: ["default_editable", "elevated_editable"],
    needsElevationFor: ["elevated_editable"],
    immutableZones: IMMUTABLE_ZONES,
  ...
  {
    toolName: "vfs_merge",
    summary: "Deep merge JSON objects atomically.",
    readOnly: false,
    mayWriteClasses: ["default_editable", "elevated_editable"],
    needsElevationFor: ["elevated_editable"],
    immutableZones: IMMUTABLE_ZONES,
  ...
  {
    toolName: "vfs_tx",
    summary: "Apply mixed operations atomically (optional commit_turn last).",
    readOnly: false,
    mayWriteClasses: [
      "default_editable",
      "elevated_editable",
...
for (let phase = 0; phase <= 9; phase += 1) {
  CAPABILITIES.push({
    toolName: `vfs_submit_outline_phase_${phase}`,
