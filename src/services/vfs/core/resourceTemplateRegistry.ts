...
const DEFAULT_RESOURCE_TEMPLATES: VfsResourceTemplate[] = [
  ...
  {
    id: "template.config.workspace_soul",
    description: "Workspace SOUL memory document",
    patterns: ["shared/config/workspace/SOUL.md"],
    domain: "config",
    shape: "markdown_doc",
    criticality: "core",
    retention: "save",
  ...
  {
    id: "template.config.workspace_user",
    description: "Workspace USER memory document",
    patterns: ["shared/config/workspace/USER.md"],
    domain: "config",
    shape: "markdown_doc",
    criticality: "core",
    retention: "save",
  ...
  {
    id: "template.config.workspace_identity",
    description: "Workspace IDENTITY memory document",
    patterns: ["shared/config/workspace/IDENTITY.md"],
    domain: "config",
    shape: "markdown_doc",
    criticality: "core",
    retention: "save",
  ...
  {
    id: "template.story.workspace_plan",
    description: "Save-scoped workspace PLAN document",
    patterns: ["forks/*/story/workspace/PLAN.md"],
    domain: "story",
    shape: "markdown_doc",
    criticality: "core",
    retention: "save",
  ...
  {
    id: "template.runtime.session_jsonl",
    description: "Fork runtime session history mirrors",
    patterns: ["forks/*/runtime/session/*.jsonl"],
    domain: "runtime",
    shape: "append_log",
    criticality: "secondary",
    retention: "session",
  ...
  {
    id: "template.runtime.session_lineage",
    description: "Fork runtime session lineage graph",
    patterns: ["forks/*/runtime/session/lineage.json"],
    domain: "runtime",
    shape: "singleton_json",
    criticality: "secondary",
    retention: "session",
