...
export const CUSTOM_RULE_CATEGORY_PRESETS: readonly CustomRuleCategoryPreset[] = [
  {
    ...
    slug: "system-core",
    title: "System Core",
    directoryPurpose: "Core behavior constraints that always anchor the storyteller.",
    whenToApply: "Always apply. Use for non-negotiable system-level constraints.",
    starterRules: [
  ...
  },
  {
    ...
    slug: "world-setting",
    title: "World Setting",
    directoryPurpose: "Rules for world physics, institutions, technology, and social order.",
    whenToApply: "Apply when scenes rely on setting logic or world consistency.",
    starterRules: [
  ...
  },
  {
    ...
    slug: "protagonist",
    title: "Protagonist",
    directoryPurpose: "Rules for player-character agency, constraints, and growth arcs.",
    whenToApply: "Apply whenever protagonist decisions or development is central.",
    starterRules: [
  ...
  },
  {
    ...
    slug: "npc-behavior",
    title: "NPC Behavior",
    directoryPurpose: "Rules for NPC motivations, memory, and social behavior.",
    whenToApply: "Apply in social, political, investigative, or relationship scenes.",
    starterRules: [
  ...
  },
  {
    ...
    slug: "combat-action",
    title: "Combat & Action",
    directoryPurpose: "Rules for pacing, stakes, and consequence in conflict scenes.",
    whenToApply: "Apply in combat, chase, stealth, and other high-intensity action beats.",
    starterRules: [
  ...
  },
  {
    ...
    slug: "dialogue",
    title: "Dialogue",
    directoryPurpose: "Rules for voice differentiation, subtext, and conversational flow.",
  ...
  },
  {
    ...
    slug: "mystery",
    title: "Mystery",
    directoryPurpose: "Rules for clues, suspicion management, and reveal pacing.",
    whenToApply: "Apply when hidden information and investigation loops are active.",
    starterRules: [
  ...
  },
  {
    ...
    directoryPurpose: "Rules for how game state changes are represented and validated.",
    whenToApply: "Apply when introducing, updating, or reconciling stateful entities.",
    starterRules: [
  ...
  },
  {
    ...
    slug: "hidden-truth",
    title: "Hidden Truth",
    directoryPurpose: "Rules governing secret layers, disclosure timing, and dramatic payoff.",
    whenToApply: "Apply when managing secrets, deception, and revelation arcs.",
    starterRules: [
  ...
  },
  {
    ...
    slug: "image-style",
    title: "Image Style",
    directoryPurpose: "Rules for visual consistency in image and scene generation outputs.",
  ...
  },
  {
    ...
    slug: "cultural",
    title: "Cultural",
    directoryPurpose: "Rules for localization, cultural framing, and audience adaptation.",
    whenToApply: "Apply whenever cultural context or language adaptation is relevant.",
    starterRules: [
  ...
  },
  {
    ...
    slug: "custom",
    title: "Custom",
    directoryPurpose: "Catch-all category for project-specific constraints and experiments.",
...
const ROOT_CATEGORY_DIRECTORIES = [
  {
    ...
    title: "Characters",
    purpose: "Actor profiles and per-actor assets. Keep IDs stable and explicit.",
  },
  {
  ...
  },
  {
    path: "world/quests",
    title: "Quests",
    purpose: "Quest definitions, progression metadata, and objective structure.",
  },
  {
...
const buildReadme = ({ title, purpose }: { title: string; purpose: string }): string =>
  [
    `# ${title}`,
    "",
    purpose,
...
const SCAFFOLD_DEFINITIONS: readonly DirectoryScaffoldDefinition[] = [
  ...
  ...CUSTOM_RULE_CATEGORY_PRESETS.map((preset) => {
    ...
    return {
      ...
      readme: buildReadme({ title: `${preset.title} Rules`, purpose: preset.directoryPurpose }),
...
export const getCustomRuleCategoryPreset = (
  category: RuleCategory,
): CustomRuleCategoryPreset | undefined => CUSTOM_RULE_PRESET_BY_CATEGORY.get(category);
...
export const getCustomRuleCategoryDirectoryPath = (category: RuleCategory): string => {
...
export const ensureDirectoryReadme = (
  ...
  const title = toTitleCase(normalizedDirectoryPath.split("/").pop() ?? "Directory");
  const content =
    options?.content ??
    buildReadme({
