...
export const ENV_THEMES: Record<string, ThemeConfig> = {
  ...
  steampunk: {
    vars: {
      "--theme-bg": "#1a0f0a",
      "--theme-surface": "#2d1a12",
      "--theme-surface-highlight": "#452a1e",
      "--theme-border": "#b45309",
      "--theme-primary": "#f59e0b",
      "--theme-primary-hover": "#d97706",
      "--theme-text": "#fde68a",
    ...
    dayVars: {
      "--theme-bg": "#fef3c7",
      "--theme-surface": "#ffffff",
      "--theme-surface-highlight": "#fde68a",
      "--theme-border": "#d97706",
      "--theme-primary": "#b45309",
      "--theme-primary-hover": "#92400e",
      "--theme-text": "#451a03",
  ...
  // Liminal / Backrooms Yellow
  liminal: {
    vars: {
      "--theme-bg": "#1c1c16",
      "--theme-surface": "#2d2d24",
      "--theme-surface-highlight": "#3f3f33",
      "--theme-border": "#a3a375",
      "--theme-primary": "#d4d44d",
      "--theme-primary-hover": "#b8b835",
      "--theme-text": "#eeeecc",
      "--theme-muted": "#888866",
      ...DEFAULT_STATE_VARS,
      "--theme-warning": "#d4d44d",
      "--theme-danger": "#ef4444",
    },
    dayVars: {
      "--theme-bg": "#ffffd9",
      "--theme-surface": "#ffffff",
      "--theme-surface-highlight": "#fafaeb",
      "--theme-border": "#d4d44d",
      "--theme-primary": "#8a8a2a",
      "--theme-primary-hover": "#6e6e1d",
      "--theme-text": "#2d2d14",
      "--theme-muted": "#6b6b47",
      ...DEFAULT_DAY_STATE_VARS,
    },
