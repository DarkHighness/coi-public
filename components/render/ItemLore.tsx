...
export const ItemLore: React.FC<ItemLoreProps> = ({ lore, labelHistory, labelShowMore, labelShowLess }) => {
  const [isExpanded, setIsExpanded] = useState(false);
  const LORE_LIMIT = 150;

  return (
    <div className="pt-2 border-t border-theme-border">
        <span className="text-[10px] uppercase tracking-wider text-theme-primary font-bold mb-1 block">{labelHistory}</span>
