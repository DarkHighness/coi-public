       ...
       <div className="bg-theme-surface border border-theme-border rounded max-w-md w-full max-h-[80vh] flex flex-col shadow-2xl">
           ...
           <div className="p-4 overflow-y-auto space-y-3 flex-1">
              ...
              {slots.map(slot => {
                 ...
                 return (
                    <div key={slot.id} className={`p-3 rounded border flex justify-between items-center group ${isCurrent ? 'border-theme-primary bg-theme-primary/10' : 'border-theme-border bg-theme-bg hover:border-theme-muted'}`}>
