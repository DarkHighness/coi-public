...
export const SystemFooter: React.FC<SystemFooterProps> = ({
  ...
  return (
    <div className="shrink-0 p-6 border-t border-theme-border bg-theme-surface/30 space-y-6 mt-auto">
      ...
      <div>
        <button
          onClick={() => { onMagicMirror(); onCloseMobile(); }}
        ...
        >
           <svg className="w-5 h-5 mr-2 text-theme-primary group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
           {t('magicMirror')}
        </button>
      </div>
      ...
      {/* System Panel */}
      <div>
        <h2 className={`text-theme-primary uppercase text-xs font-bold tracking-widest mb-4 flex items-center ${themeFont}`}>
        ...
        {/* Second Row of System Buttons */}
         <div className="grid grid-cols-1 gap-2 mt-2">
           <button
             onClick={() => { onSettings(); onCloseMobile(); }}
