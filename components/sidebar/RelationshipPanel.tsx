          ...
          {safeRelationships.length === 0 ? (
            ...
            safeRelationships.map((rel, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-theme-surface-highlight/30 p-3 rounded border border-theme-border hover:border-theme-primary/30 transition-colors"
                >
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-bold text-theme-text text-sm">
                      {rel.name}
                    </span>
                    <span className="text-[10px] uppercase tracking-wider bg-theme-bg px-2 py-0.5 rounded text-theme-primary border border-theme-border">
                      {rel.status}
                    </span>
                  </div>
