...
export const MobileGameLayout: React.FC<MobileGameLayoutProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden relative md:hidden">
      {/* 1. Story Feed View */}
      <div className={`flex-1 flex flex-col h-full w-full absolute inset-0 transition-opacity duration-300 ${mobileTab === 'story' ? 'z-10 opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
         <StoryFeed
           gameState={gameState}
