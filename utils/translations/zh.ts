...
export const zh = {
  ...
  "timeline.export": "导出时间轴",
  "timeline.exportTitle": "无尽编年史",
  "timeline.exportSubtitle": "旅程时间轴导出",
  "timeline.generatedBy": "由无尽编年史生成",
  character: "角色状态",
  showChoices: "显示选项",
  hideChoices: "隐藏选项",
  skills: "技能",
  ...
  models: {
    ...
    temperatureHelp: "控制随机性 (0 = 确定性, 2 = 创造性)",
    topP: "Top P",
    topPHelp: "核采样 (越低越专注)",
    topK: "Top K",
    topKHelp: "限制词汇表为前 K 个 token",
    minP: "Min P",
    minPHelp: "最小概率阈值",
  },
  customize: "自定义",
  ...
  toast: {
    ...
    locationDiscovered: "发现新地点",
    locationsDiscovered: "个地点已发现",
    skillGained: "习得新技能",
    conditionChanged: "状态已变化",
  ...
  commands: {
    godMode: {
      confirmEnable: "⚠️ 上帝模式 ⚠️\n\n这将启用上帝模式：\n• 所有行动都会成功\n• 所有 NPC 无条件相信你\n• 你可以改变世界规则和逻辑\n\n这可能会严重影响游戏平衡。\n\n确定要启用上帝模式吗？",
      confirmDisable: "关闭上帝模式并恢复正常游戏？",
      enabled: "🔱 上帝模式已启用",
      disabled: "上帝模式已关闭",
      indicator: "上帝模式",
    },
    ...
    help: "可用命令：\n/god - 切换上帝模式（行动必成功，NPC服从）\n/unlock - 显示所有隐藏信息\n/edit - 打开状态编辑器\n/help - 显示帮助信息",
  },
  // 状态编辑器
  stateEditor: {
    title: "状态编辑器",
    subtitle: "直接编辑游戏状态（开发者工具）",
    character: "角色",
    inventory: "背包",
    relationships: "关系",
    locations: "地点",
    ...
    applied: "更改已应用",
    applyFailed: "应用更改失败",
    invalidJson: "无效的 JSON 语法",
    fixErrors: "请先修复 JSON 错误",
    warning: "更改会立即生效，请谨慎操作！",
  },
  // 结局信息
  gameOver: "游戏结束",
  victory: "胜利",
  ...
  badEnding: "坏结局",
  ending: "终",
  endingHint: "你可以从之前的节点分支尝试不同的路线",
  endingFinal: "这个故事已经结束了",
  unlocked: "已解锁",
  secretAgenda: "隐藏议程",
};
