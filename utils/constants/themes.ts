...
export const THEMES: Record<string, StoryThemeConfig> = {
  ...
  cyberpunk: { defaultEnvTheme: "cyberpunk", icon: "🌃", categories: ["fantasy"] },
  horror: { defaultEnvTheme: "horror", icon: "👻", categories: ["suspense"] },
  mystery: { defaultEnvTheme: "mystery", icon: "🔍", categories: ["suspense"] },
  modern_romance: { defaultEnvTheme: "romance", icon: "❤️", categories: ["modern"] },
  palace_drama: { defaultEnvTheme: "royal", icon: "👑", categories: ["ancient"] },
  wuxia: { defaultEnvTheme: "wuxia", icon: "⚔️", categories: ["ancient"] },
  demonic_cultivation: { defaultEnvTheme: "demonic", icon: "😈", categories: ["ancient"] },
  xianxia: { defaultEnvTheme: "ethereal", icon: "✨", categories: ["ancient"] },
  infinite_flow: { defaultEnvTheme: "danger", icon: "♾️", categories: ["fantasy"] },
  entertainment: { defaultEnvTheme: "glamour", icon: "🎬", categories: ["modern"] },
  esports: { defaultEnvTheme: "rgb", icon: "🎮", categories: ["modern"] },
  ceo: { defaultEnvTheme: "modern", icon: "💼", categories: ["modern"] },
  long_aotian: { defaultEnvTheme: "gold", icon: "💪", categories: ["suspense"] },
  villain_op: { defaultEnvTheme: "villain", icon: "🦹", categories: ["suspense"] },
  period_drama: { defaultEnvTheme: "sepia", icon: "🎭", categories: ["ancient"] },
  female_growth: { defaultEnvTheme: "rose", icon: "🌸", categories: ["suspense"] },
  war_god: { defaultEnvTheme: "war", icon: "🛡️", categories: ["suspense"] },
  ancient_romance: { defaultEnvTheme: "sunset", icon: "💖", categories: ["ancient"] },
  love_after_marriage: { defaultEnvTheme: "romance", icon: "💍", categories: ["modern"] },
  angst: { defaultEnvTheme: "cold", icon: "💔", categories: ["suspense"] },
  reunion: { defaultEnvTheme: "violet", icon: "🤝", categories: ["modern"] },
  return_strong: { defaultEnvTheme: "war", icon: "🔥", categories: ["suspense"] },
  farming: { defaultEnvTheme: "nature", icon: "🌾", categories: ["fantasy"] },
  republican: { defaultEnvTheme: "artdeco", icon: "🎩", categories: ["ancient"] },
  intrigue: { defaultEnvTheme: "intrigue", icon: "🤫", categories: ["ancient"] },
  survival: { defaultEnvTheme: "wasteland", icon: "🏕️", categories: ["suspense"] },
  patriotism: { defaultEnvTheme: "patriotic", icon: "🇨🇳", categories: ["modern"] },
  son_in_law: { defaultEnvTheme: "cyan", icon: "👨‍👩‍👧", categories: ["modern"] },
  white_moonlight: { defaultEnvTheme: "silver", icon: "🌕", categories: ["modern"] },
  yandere: { defaultEnvTheme: "obsessive", icon: "🔪", categories: ["suspense"] },
  cs_student: { defaultEnvTheme: "emerald", icon: "💻", categories: ["modern"] },
  rough_guy: { defaultEnvTheme: "stone", icon: "👊", categories: ["modern"] },
  wife_chasing: { defaultEnvTheme: "heartbreak", icon: "🏃‍♀️", categories: ["modern"] },
  special_forces: { defaultEnvTheme: "war", icon: "🎖️", categories: ["modern"] },
  zombie: { defaultEnvTheme: "horror", icon: "🧟", categories: ["suspense"] },
  body_swap: { defaultEnvTheme: "modern", icon: "👯", categories: ["modern"] },
  industry_elite: { defaultEnvTheme: "modern", icon: "🏢", categories: ["modern"] },
  mutual_redemption: { defaultEnvTheme: "violet", icon: "💞", categories: ["modern"] },
  sweet_pet: { defaultEnvTheme: "romance", icon: "🍬", categories: ["modern"] },
  wild_youth: { defaultEnvTheme: "modern", icon: "🎸", categories: ["modern"] },
  rebirth_revenge: { defaultEnvTheme: "intrigue", icon: "🩸", categories: ["suspense", "modern"] },
  flash_marriage: { defaultEnvTheme: "romance", icon: "⚡", categories: ["modern"] },
  family_ethics: { defaultEnvTheme: "sepia", icon: "🏠", categories: ["modern"] },
  divine_doctor: { defaultEnvTheme: "nature", icon: "💊", categories: ["modern", "fantasy"] },
  cute_pet: { defaultEnvTheme: "nature", icon: "🐾", categories: ["modern", "fantasy"] },
  hidden_identity: { defaultEnvTheme: "mystery", icon: "🕶️", categories: ["modern", "suspense"] },
  system_stream: { defaultEnvTheme: "scifi", icon: "🤖", categories: ["fantasy", "modern"] },
  wealthy_family: { defaultEnvTheme: "gold", icon: "💰", categories: ["modern", "suspense"] },
  cs_grad_journey: { defaultEnvTheme: "emerald", icon: "🎓", categories: ["modern"], restricted: true },
};
