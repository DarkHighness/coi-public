import { GameState, InventoryItem, Relationship, Location, KnowledgeEntry, Quest } from "../types";
...
export const findInventoryItem = (gameState: GameState, idOrName: number | string): InventoryItem | undefined => {
...
export const findRelationship = (gameState: GameState, idOrName: number | string): Relationship | undefined => {
    if (typeof idOrName === 'number') {
...
export const findLocation = (gameState: GameState, idOrName: number | string): Location | undefined => {
    if (typeof idOrName === 'number') {
